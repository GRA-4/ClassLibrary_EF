    ...
    public partial class initial1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenreTitle", x => new { x.GenresGenreId, x.TitlesTitleId });
                    table.ForeignKey(
                        name: "FK_GenreTitle_Genres_GenresGenreId",
                        column: x => x.GenresGenreId,
                        principalTable: "Genres",
                        principalColumn: "GenreId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GenreTitle_Titles_TitlesTitleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NamePost = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValueSql: "(N'')")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListTitle", x => new { x.ListsListId, x.TitlesTitleId });
                    table.ForeignKey(
                        name: "FK_ListTitle_Lists_ListsListId",
                        column: x => x.ListsListId,
                        principalTable: "Lists",
                        principalColumn: "ListId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListTitle_Titles_TitlesTitleId",
                        column: x => x.TitlesTitleId,
                        principalTable: "Titles",
                        principalColumn: "TitleId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenreTitle_TitlesTitleId",
                table: "GenreTitle",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListTitle_TitlesTitleId",
                table: "ListTitle",
                column: "TitlesTitleId");
